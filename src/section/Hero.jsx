  ...
  return (
    <section
     ...
     <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
      ...
      <div className="relative justify-center flex-1 flex items-center xl:min-h-screen max-lg:py-40 bg-primary bg-cover bg-hero bg-center">
      ...
      <div className="flex absolute -bottom-[5%] sm:left[10%] max-sm:px-6 sm:gap-6 gap-4">
        {shoes.map((shoe, index) => (
          <div key={index}>
            <ShoesCard  imgUrl={shoe} bigShoeImage={bigShoeImg} changeBigShoeImage={(shoe) => {setBigShoeImg(shoe)}}/>
          </div>
        ))}
      </div>
      </div>
